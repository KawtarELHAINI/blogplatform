    ...
    if (isset($_POST['login'])) {
        ...
        if ($userFromDatabase) {
            ...
            if ($nameRole == 'admin') {
                ...
                header("location:/Blogging/app/view/adminIndex.php");
                exit();
                ...
                header("location:/Blogging/app/view/authorwikis.php");
                exit();
            } else {
                echo "<script>
                        setTimeout(function() {
                            window.location.href = '/Blogging/public/login.php?error=Invalid username or password';
...
if (isset($_POST['register'])) {
    ...
    if (empty(trim($username)) && empty(trim($email))  && empty(trim($password))) {
        ...
        header("location:/Blogging/public/login.php");
        exit();
    }
